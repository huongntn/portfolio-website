...
<img src="{{ '/assets/images/SUD_Re02_IMG01.png' | relative_url }}" 
...
<img src="{{ '/assets/images/SUD_Re02_IMG02.png' | relative_url }}" 
     alt="France/Indochine Architecture" 
     class="about-img-rect" 
     style="max-width: 100%; border-radius: 8px; margin: 20px 0;">
...
<img src="{{ '/assets/images/SUD_Re02_IMG03.png' | relative_url }}" 
     alt="France/Indochine Architecture" 
     class="about-img-rect" 
     style="max-width: 100%; border-radius: 8px; margin: 20px 0;">
...
<img src="{{ '/assets/images/SUD_Re02_IMG04.png' | relative_url }}" 
     alt="Modernism/Tropical Architecture" 
     class="about-img-rect" 
     style="max-width: 100%; border-radius: 8px; margin: 20px 0;">
...
<img src="{{ '/assets/images/SUD_Re02_IMG05.png' | relative_url }}" 
     alt="Harmonized Architecture" 
     class="about-img-rect" 
     style="max-width: 100%; border-radius: 8px; margin: 20px 0;">
...
<img src="{{ '/assets/images/SUD_Re02_IMG06.png' | relative_url }}" 
...
<img src="{{ '/assets/images/SUD_Re02_IMG07.png' | relative_url }}" 
     alt="Mordern Row Houses" 
     class="about-img-rect" 
     style="max-width: 100%; border-radius: 8px; margin: 20px 0;">
...
<img src="{{ '/assets/images/SUD_Re02_IMG08.png' | relative_url }}" 
     alt="Mordern Row Houses" 
     class="about-img-rect" 
     style="max-width: 100%; border-radius: 8px; margin: 20px 0;">
