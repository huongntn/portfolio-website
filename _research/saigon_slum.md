...
full_paper_url: https://www.researchgate.net/publication/408393480_Residential_Areas_in_Tan_Tao_A_Binh_Tan_District_under_impacts_of_Tan_Tao_Industrial_Park
...
<img src="{{ '/assets/images/SUD_Re03_IMG01.png' | relative_url }}" 
     alt="Tan Tao A slum map" 
...
<img src="{{ '/assets/images/SUD_Re03_IMG02.png' | relative_url }}" 
     alt="Tan Tao A slum house and architecture" 
     class="about-img-rect" 
     style="max-width: 100%; border-radius: 8px; margin: 20px 0;">
...
<img src="{{ '/assets/images/SUD_Re03_IMG05.png' | relative_url }}" 
     alt="Interview with local people" 
     class="about-img-rect" 
     style="max-width: 100%; border-radius: 8px; margin: 20px 0;">
...
<img src="{{ '/assets/images/SUD_Re03_IMG03.png' | relative_url }}" 
     alt="Trash in the slum" 
     class="about-img-rect" 
     style="max-width: 100%; border-radius: 8px; margin: 20px 0;">
...
<img src="{{ '/assets/images/SUD_Re03_IMG04.png' | relative_url }}" 
     alt="Local markets and shops" 
     class="about-img-rect" 
     style="max-width: 100%; border-radius: 8px; margin: 20px 0;">
...
<img src="{{ '/assets/images/SUD_Re03_IMG06.png' | relative_url }}" 
